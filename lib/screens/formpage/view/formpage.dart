              ...
              child: Column(
                ...
                children: [
                  ...
                  Obx(() => KRadio(
                        ...
                        onChanged: (value) {
                          controller.setSelectedOption(value!, "Yes");
                          return null;
                        },
                      )),
                  Obx(() => KRadio(
                        ...
                        groupValue: controller.selectedOption.value,
                        onChanged: (value) {
                          controller.setSelectedOption(value!, "No");
                          return null;
                        },
                      )),
                  CustomText(
                  ...
                  Obx(() => KRadio(
                        ...
                        onChanged: (value) {
                          controller.setSelectedOption1(
                              value!, "Promissioary note");
                          return null;
                        },
                      )),
                  Obx(() => KRadio(
